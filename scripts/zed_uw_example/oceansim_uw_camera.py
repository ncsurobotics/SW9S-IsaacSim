# Local copy of OceanSim UW_Camera to avoid package import issues
...
from .oceansim_uw_renderer import UW_render
        ...
        with self.window.frame:
            with ui.ZStack(height=720):
                ...
                image_provider = ui.ImageWithProvider(
                    ...
                    width=1280,
                    height=720,
                    style={"fill_policy": ui.FillPolicy.PRESERVE_ASPECT_FIT, "alignment": ui.Alignment.CENTER},
                )
